# Background: Farm Observations

This note gives the observational background for the repository. It is not a
technical definition of Geometric Reflexive Coherence. It records the farm,
ecosystem, flock, plant, and insect observations that motivated the move from
local-agent explanations toward questions of coherence, thresholds, support,
collective memory, and identity across scale.

For a technical first pass, start with `QUICK_START.md` or the papers in
`core/`.
...
I've played with various ant colony optimization algorithms to bring at least some ability to adapt to changes and making the code flow more robust. But the results were far from what I could observe in any real ant colony. Mostly because the ant colony has been adopted from the view of path optimizations which solves part of the problem, but doesn't touch how the colony functions fully. Over time, I dove more and more into biology, and the works of E.O.Wilson, especially books like Superorganism and Social Conquest of Earth. But the idea of collective emergence of multiple insects as one organism was a domain on its own. It lacked any kind of mapping to algorithmic problems.
